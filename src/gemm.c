...
{
    if (m >= 192 && m <= 384 && (m % 32) == 0 && n >= 1280 && n <= 1472 &&
        k >= 832 && k <= 1152) {
        return 1;
    }
    ...
    if (m == 512 && n >= 1280 && n <= 1408 && (k == 832 || k == 960)) {
        return 1;
    }
    if (m == 544 && n >= 1280 && n <= 1408 && (k == 832 || k == 960)) {
        return 1;
    }
    ...
    if (m == 640 && n >= 1280 && n <= 1408 && (k == 832 || k == 960)) {
        return 1;
    }
    if (m == 672) {
        if (n == 1280) {
